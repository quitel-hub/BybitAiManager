...
warnings.filterwarnings('ignore')
print("🧠 Инициализация нейро-модуля (Single-Market 15m Edition)...")

# --- 1. ЗАГРУЗКА И ПОДГОТОВКА ---
with open('dataset_btc_15m.json', 'r') as f:
    data = json.load(f)
...
print("⚙️ Рассчитываем метрики (строго как в predict.py)...")
...
# Цель: вырастет ли следующая свеча?
...
# ТОТ САМЫЙ СПИСОК ФИЧЕЙ (1-в-1 как в predict.py)
features = [
    'hour', 'day_of_week', 
